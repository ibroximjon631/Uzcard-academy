...
| Файл / папка | Описание |
|------|----------|
| **`mini-project-data-analysis/`** | **Mini-project: Data analysis — трек D (OqPay Super-App): notebook с 4 гипотезами, презентации RU/UZ, сценарии защиты, полный отчёт; запасные треки A/B/C в `alt-tracks/`** |
